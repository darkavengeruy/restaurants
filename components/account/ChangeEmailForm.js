...
export default function ChangeEmailForm({
    ...
    const onSubmit = async () => {
      ...
      if (!resultUpdateEmail.statusResponse) {  
        setErrorEmail(" No se puede cambiar este correo. Ya esta en uso por otro usuario.");
        return;
      }
    ...
    const validateForm = () => {
      ...
      if (newEmail === email) {
        setErrorEmail(
          "Debes ingresar un email diferente al actual.");
        isValid = false;
      }
    ...
    return (
      <View style={styles.view}>
        ...
        />
        <Button
          title="Cambiar Email y Contraseña"
